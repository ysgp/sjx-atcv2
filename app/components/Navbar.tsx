      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="w-8 h-8 sm:w-9 sm:h-9 rounded-full flex items-center justify-center transition-all hover:ring-2 hover:ring-accent/50 focus:outline-none focus:ring-2 focus:ring-accent"
            aria-label="用戶選單"
          >
            {discordUser?.avatar ? (
              <img 
              ...
              <div className="w-full h-full rounded-full bg-accent flex items-center justify-center text-cream text-sm font-bold">
                VS
              </div>
            )}
          </button>
          ...
          {/* Dropdown Menu */}
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-64 bg-primary-dark border border-cream/20 rounded-xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 z-50">
              {discordUser ? (
                <>
                  {/* User Info */}
                ...
                <>
                  ...
                  <div className="p-4 border-b border-cream/10">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-cream font-semibold">訪客</p>
                        <p className="text-cream/50 text-xs">未登入</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-3">
                    <button
                      ...
                      className="w-full px-4 py-2.5 bg-[#5865F2] hover:bg-[#4752C4] text-cream rounded-lg font-semibold text-sm transition-colors flex items-center justify-center gap-2"
                    >
